export default function BriefContent({ act, animKey }) {
  return (
    <div key={animKey} style={{ background: act.contentBg, paddingBottom: "48px" }}>
      {/* Context + Task */}
      <div className="brief-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", borderBottom: `1px solid ${act.border}` }}>
        <div className="fu0 brief-section brief-divider" style={{ padding: "30px 36px", borderRight: `1px solid ${act.border}` }}>
        ...
        <div className="fu1 brief-section" style={{ padding: "30px 36px" }}>
      ...
      {/* Criteria */}
      <div className="fu2 criteria-wrap" style={{ padding: "26px 36px 0" }}>
        ...
        <div className="criteria-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "8px" }}>
          {act.pillars.map((p, i) => (
      ...
      {/* Options */}
      <div className="fu3 options-wrap" style={{ padding: "22px 36px 0" }}>
        <div style={{ display: "flex", alignItems: "center", gap: "12px", marginBottom: "12px" }}>
          <div style={{ height: "1px", flex: 1, background: act.border }} />
        ...
        <div className="options-grid" style={{ display: "grid", gridTemplateColumns: act.options.length === 7 ? "repeat(4,1fr)" : "repeat(3,1fr)", gap: "8px" }}>
          {act.options.map((o, i) => (
